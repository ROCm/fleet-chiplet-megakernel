...
MPK_FORWARD_VARS=(
  ...
  MPK_OPROJ_KMAJOR MPK_LM_HEAD_KMAJOR MPK_LM_HEAD_WAVE_TILE_DMA MPK_LM_HEAD_GROUP_PIPELINE MPK_QKV_LDS_NORM MPK_TOPK_LOCAL_MAX3
  MPK_EMBED_WIDE MPK_EMBED_PRODUCERS
  MPK_QKV_MFMA_UNROLLED MPK_W13_T0_MFMA_UNROLLED MPK_W2_T0_MFMA_UNROLLED
  MPK_ROTATE_QKV_ATTN_RANKS MPK_QKV_ROT_OVERRIDE MPK_ATTN_SLICE_RELEASE
  ...
  MPK_W13_T1_EARLY_SCALE_LOAD MPK_QKV_PREFETCH_SCALES MPK_W13_T1_SPLIT_LDS_STAGE MPK_W13_KMAJOR_RECYCLE MPK_W13_BIAS_COUNTED_WAIT
  MPK_SYS_POLL_LOAD MPK_QKV_GATE_NO_AGENT_FENCE MPK_NARROW_GATE_POLL MPK_SLICE_DUAL_POLL MPK_NARROW_OPROJ_HIER MPK_W13_BIAS_PREFETCH MPK_W13_T0_COUNTED_HANDOFF
  MPK_W13_BIAS_PF_T0_ONLY MPK_W13_T1_BIAS_EARLY MPK_LEAN_ARRIVE MPK_W2_ONLY_ARRIVE MPK_ROUTER_FUSED_DP MPK_ROUTER_DUAL_REDUCE MPK_ARGMAX_DUAL_REDUCE MPK_RMSNORM_DPP_REDUCE MPK_QKV_PF_WAVE_SPLIT MPK_OPROJ_LEAN_ACQUIRE MPK_MOE_PAD_ROUND MPK_W13_PREQUANT MPK_OPROJ_ARRIVE_ONLY MPK_ROUTING_LANE_RELEASE MPK_ROUTING_DERIVED_EPOCH MPK_MERGE_KV_OUTER MPK_MERGE_TWO_PASS

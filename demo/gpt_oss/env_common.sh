...
MPK_FORWARD_VARS=(
  ...
  MPK_W13_BIAS_PF_T0_ONLY MPK_LEAN_ARRIVE MPK_W2_ONLY_ARRIVE MPK_ROUTER_FUSED_DP MPK_ROUTER_DUAL_REDUCE MPK_ARGMAX_DUAL_REDUCE MPK_QKV_PF_WAVE_SPLIT MPK_OPROJ_LEAN_ACQUIRE MPK_MOE_PAD_ROUND MPK_W13_PREQUANT MPK_OPROJ_ARRIVE_ONLY MPK_ROUTING_LANE_RELEASE MPK_ROUTING_DERIVED_EPOCH MPK_MERGE_KV_OUTER MPK_MERGE_TWO_PASS

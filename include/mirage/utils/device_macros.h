...
// These macros are used throughout Mirage and are compatible with both CUDA and
// HIP They do NOT require CUTLASS - the "CUTLASS_" prefix is just for
// compatibility with existing code that uses CUTLASS naming conventions

// Suppress macro redefinition warnings - CUTLASS may define these for host
// code, and we intentionally redefine them for device code contexts
...
// Ensure __host__ and __device__ are defined for host code compilation (e.g.
// Cython)
#ifndef __HIP__
#ifndef __host__
#define __host__

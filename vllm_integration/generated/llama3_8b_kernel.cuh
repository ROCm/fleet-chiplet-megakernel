 ...
 * Fleet MK: Persistent kernel for llama3-8b (Dense) using device function library
 *
...
// ============================================================================
// llama3-8b Architecture Constants
// ============================================================================
namespace llama3_8b {
...
static constexpr int INTERMEDIATE_SIZE = 14336;
static constexpr int VOCAB_SIZE = 128256;
static constexpr int PADDED_VOCAB_SIZE = 128512;  // next multiple of 256
...
static constexpr int GATEUP_OUTPUT_SIZE = 2 * INTERMEDIATE_SIZE;       // 28672
static constexpr int GATEUP_N_WGS = GATEUP_OUTPUT_SIZE / GATEUP_OPW;  // 224
static constexpr int GATEUP_N_WGS_PER_XCD = GATEUP_N_WGS / NUM_XCDS; // 28
...
// LM head
static constexpr int LM_N_WGS = PADDED_VOCAB_SIZE / OUTPUT_PER_WG;    // 2008
static constexpr int LM_N_WGS_PER_XCD = LM_N_WGS / NUM_XCDS;         // 251
...
static constexpr int PTRS_IN = 16;
...
namespace llama3_8b_ptr {
    ...
    static constexpr int GATEUP_SCRATCH    = 6;   // [bs, 28672] bf16
    static constexpr int SWIGLU_OUT        = 7;   // [bs, 14336] bf16
    static constexpr int LAYER_OUTPUT      = 8;   // [bs, hidden] bf16 (Down + ResAdd = next layer input)
} // namespace llama3_8b_ptr


// ============================================================================
// llama3-8b Runtime Config
// ============================================================================
struct Llama3Config {
...
// ============================================================================
// The llama3-8b persistent kernel -- built entirely from device functions
// ============================================================================
...
llama3_8b_kernel(
    ...
    int  *counter_buf)
{
    using namespace llama3_8b;
    namespace ptr = llama3_8b_ptr;

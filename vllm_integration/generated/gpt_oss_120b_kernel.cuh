...
// it: lines 0..72 belong to the layer body and Titan must not touch them, and
// lines 73..102 are Titan's own.
//
...
// Total 103 cache lines = COUNTERS_PER_LAYER. Titan's own layer barrier

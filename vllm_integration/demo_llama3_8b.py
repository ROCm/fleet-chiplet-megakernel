...
Titan demo for llama3-8b inference using two-level fusion.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Titan llama3-8b demo")
...
def load_llama3_8b_kernel(so_path: str):
    """Load the compiled Llama3 titan .so."""
...
def main():
    ...
    titan = load_llama3_8b_kernel(titan_so)
    titan.llama3_8b_init()

...
Fleet MK demo for qwen3-8b inference using two-level fusion.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Fleet MK qwen3-8b demo")
...
def load_qwen3_8b_kernel(so_path: str):
    """Load the compiled Qwen3 fleet_mk .so."""
...
def main():
    ...
    page_size = 128  # == fleet_mk PAGE_SIZE (vLLM's ROCm default block size)
    ...
    fleet_mk = load_qwen3_8b_kernel(fleet_mk_so)
    fleet_mk.qwen3_8b_init()
